...
public class A2 extends JFrame {
	...
	* @return toolsPanel		the Panel
	...
	public JPanel setUpToolsPanel() {
		...
		ImageIcon rotatingButtonIcon = createImageIcon("rotatingsquare.gif");
		JComboBox<ImageIcon> shapesComboBox = new JComboBox<ImageIcon>(new ImageIcon[] {rectangleButtonIcon,squareButtonIcon,triangleButtonIcon,rotatingButtonIcon} );
		...
		//Set up the width TextField
				JTextField penTxt = new JTextField("1");
				penTxt.setToolTipText("Set Pen Width");
				penTxt.addActionListener( new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						JTextField tf = (JTextField)e.getSource();
						try {
